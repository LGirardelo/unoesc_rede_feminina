...
class AnexosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anexo" do
    assert_difference('Anexo.count') do
      post anexos_url, params: { anexo: { arquivo: @anexo.arquivo, descricao: @anexo.descricao, tipo: @anexo.tipo } }
    end
  ...
  test "should update anexo" do
    patch anexo_url(@anexo), params: { anexo: { arquivo: @anexo.arquivo, descricao: @anexo.descricao, tipo: @anexo.tipo } }
